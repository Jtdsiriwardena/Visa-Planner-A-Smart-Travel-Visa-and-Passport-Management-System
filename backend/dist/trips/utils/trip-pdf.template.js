...
exports.generateTripHTML = generateTripHTML;
...
function generateTripHTML(trip) {
    ...
    const getVisaStatusLabel = (status) => {
        const labels = {
      ...
      <div class="container">
        ...
        <div class="summary">
          ...
          <div class="summary-card">
            ...
            <div class="summary-card-value">
              ${trip.destinations.filter((d) => d.visa_status === 'visa_required').length}<span class="summary-card-suffix"> of ${trip.destinations.length}</span>
            </div>
          </div>
        </div>
...
//# sourceMappingURL=trip-pdf.template.js.map